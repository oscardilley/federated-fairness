...
Simulating using Flower:
  The Ditto strategy
  On the NSL-KDD dataset with the niid partition.
  For 205 clients
...
path_extension = f'Ditto_NSLKDD_niid_{NUM_CLIENTS}C_{int(SELECTION_RATE * 100)}PC_{LOCAL_EPOCHS}E_{NUM_ROUNDS}R'
data = {
    "rounds": [],
    "general_fairness": {
          "f_j": [],
